...
test.describe('Profile', () => {
  ...
  test.describe('Happy path', () => {
    ...
    test('should update name successfully @profile', async ({
      profilePage,
    }) => {
  ...
  test.describe('Validations', () => {
    test('should redirect to login if not authenticated @profile', async ({
      page,
    }) => {
    ...
    test('should show error on invalid email update @profile', async ({
      profilePage,
    }) => {
      await profilePage.navigate('/account/profile')
