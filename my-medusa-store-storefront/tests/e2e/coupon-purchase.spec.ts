...
test.describe('E2E - Coupon Purchase @e2e', () => {
  ...
  test('user completes purchase with valid coupon @e2e', async ({ productListPage, productDetailPage, cartPage, checkoutPage }) => {
    ...
    await expect(checkoutPage.couponError).not.toBeVisible();
